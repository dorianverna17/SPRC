...
access_token_t *
request_access_token_1(client_status_t *argp, CLIENT *clnt)
{
	static access_token_t clnt_res;

	memset((char *)&clnt_res, 0, sizeof(clnt_res));
	if (clnt_call (clnt, REQUEST_ACCESS_TOKEN,
		(xdrproc_t) xdr_client_status_t, (caddr_t) argp,
...
int *
validate_delegated_action_1(void *argp, CLIENT *clnt)
{
	static int clnt_res;
...
approve_request_token_1(void *argp, CLIENT *clnt)
{
	static approve_request_token_t clnt_res;

	memset((char *)&clnt_res, 0, sizeof(clnt_res));
	if (clnt_call (clnt, APPROVE_REQUEST_TOKEN,
		(xdrproc_t) xdr_void, (caddr_t) argp,
		(xdrproc_t) xdr_approve_request_token_t, (caddr_t) &clnt_res,
		TIMEOUT) != RPC_SUCCESS) {
		return (NULL);
	}
	return (&clnt_res);
